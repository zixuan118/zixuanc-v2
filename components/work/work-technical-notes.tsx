...
export type WorkTechnicalNote = {
  label: string
  text: string
}

type WorkTechnicalNotesProps = {
  notes: WorkTechnicalNote[]
  triggerLabel?: string
  regionLabel?: string
}

export function WorkTechnicalNotes({
  notes,
  triggerLabel = "Technical notes",
  regionLabel = "Technical notes",
}: WorkTechnicalNotesProps) {
